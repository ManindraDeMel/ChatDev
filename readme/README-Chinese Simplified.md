...
* September 25th, 2023: The **Git** mode is now available, enabling the programmer <img src='online_log/static/figures/programmer.png' height=20> to utilize Git for version control. 要启用此功能，只需将 `"git_management"` 设置为 `"True"` 设置为 `ChatChainConfig.json` 中。 See [guide](wiki.md#git-mode).
  <p align="center">
