...
* **25 september 2023: De **Git**-functie is nu beschikbaar**, waardoor de programmeur <img src='../online_log/static/figures/programmer.png' height=20> GitHub kan gebruiken voor versiebeheer. Om deze functie in te schakelen, stelt u eenvoudigweg `"git_management"` in op `"True"` in `ChatChainConfig.json`. Zie [handleiding](wiki.md#git-mode).
  <p align="center">
